...
export default function AnalyticsPage() {
  const { data: riskScores, isLoading: riskLoading, error: riskError, refetch: riskRefetch } = useSupabaseQuery<RiskScore>({
    table: "risk_scores",
    orderBy: "score",
    ascending: true,
  ...
  const { data: complianceTrends, isLoading: trendsLoading, error: trendsError, refetch: trendsRefetch } = useSupabaseQuery<ComplianceTrend>({
