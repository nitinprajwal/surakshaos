  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        {/* Compliance Heatmap / Escalations */}
        <GlassCard className="p-0 overflow-hidden">
          <div className="px-5 py-4 border-b border-white/[0.06] flex items-center justify-between">
            <h3 className="text-sm font-semibold text-[#d4e4fa]">Escalations & Alerts</h3>
            <StatusBadge status="3 Active" variant="error" />
          </div>
          <div className="p-5 space-y-3">
            {[
              { title: "AML Policy Gap Assessment", days: 3, dept: "AML", severity: "critical" },
              { title: "Fair Practices Code Update", days: 7, dept: "Retail Banking", severity: "high" },
              { title: "Vendor Risk Review Q1", days: 2, dept: "Vendor Management", severity: "medium" },
            ].map((alert, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-[#d4e4fa] truncate">{alert.title}</p>
                  <p className="text-xs text-[#8c90a1]">{alert.dept} • Overdue {alert.days} days</p>
                </div>
                <StatusBadge 
