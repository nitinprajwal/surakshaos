...
import { Building2, Bell, Shield, Brain, Palette, Save, ChevronRight, Loader2, RefreshCw } from "lucide-react";
          ...
          <GlassCard className="p-6">
            ...
            <div className="mt-8 pt-4 border-t border-white/[0.06] flex items-center justify-between">
              ...
              <button onClick={handleSave} disabled={isSaving}
                className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#b0c6ff] text-[#002d6f] hover:bg-[#b0c6ff]/90 disabled:opacity-60 transition-colors text-sm font-medium">
