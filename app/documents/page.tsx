...
export default function DocumentsPage() {
  ...
  const totalObligations = documents.reduce((sum, d) => sum + (d.obligations_extracted ?? 0), 0);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="All uploaded compliance documents with AI extraction status and obligation counts."
        actions={
          <Link
            href="/upload"
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#b0c6ff] text-[#002d6f] hover:bg-[#b0c6ff]/90 transition-colors text-sm font-medium"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Total Documents", value: totalDocs, icon: Database, color: "text-[#b0c6ff]", bg: "bg-[#b0c6ff]/10 border-[#b0c6ff]/20" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-semibold text-[#d4e4fa]">All Documents</h2>
          ...
          {isLoading ? (
            ...
            <GlassCard className="p-12 text-center">
              ...
              <p className="text-[#8c90a1] text-sm mb-3">No documents uploaded yet.</p>
