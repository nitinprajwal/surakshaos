...
import {
  ...
  ShieldCheck, Zap, FileText, X,
} from "lucide-react";
import { cn } from "@/lib/utils";

const COMMANDS = [
  { id: "dashboard",       label: "Executive Dashboard",         href: "/dashboard",         icon: LayoutDashboard, group: "Pages" },
  { id: "upload",          label: "Upload Document",             href: "/upload",             icon: Upload,         group: "Pages" },
  ...
  { id: "map-board",       label: "MAP Operations Board",        href: "/map-board",          icon: GitBranch,      group: "Pages" },
  { id: "knowledge-graph", label: "Compliance Knowledge Graph",  href: "/knowledge-graph",    icon: Network,        group: "Pages" },
  { id: "drift",           label: "Regulatory Drift Analyzer",   href: "/drift",              icon: GitCompare,     group: "Pages" },
  ...
  { id: "impact",          label: "Impact Simulation",           href: "/impact",             icon: Zap,            group: "Pages" },
